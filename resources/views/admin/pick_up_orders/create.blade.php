        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex m-2 p-2">
                    <a href="{{route('admin.pick_up_orders.index')}}" class="px-4 py-2 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg text-white ">Go Orders (Pick Ups)</a>
                </div>
            </div>
        </div>
        <div>
            ...
            <form class="max-w-sm mx-auto">
                ...
                <button type="submit" class="py-3 px-6 mt-4 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"> Register new Go Order</button>
